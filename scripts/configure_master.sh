...
echo "[MASTER] Updating /etc/hosts safely..."
{
    echo ""
    echo "# Cluster hosts"
...
# OPTIONAL: uncomment if snapshots include old NameNode metadata
...
echo "[MASTER] Writing Hadoop workers file..."
...
echo "[MASTER] Master configuration applied!"
``